module.exports = {
    ...
    dirNotice: 'notice',
    dirFile: 'file',
    ignoreSize: -1,   // 忽略大小大于 ignoreSize(单位是MB) 的课程文件, -1 表示不忽略
    ignoreCount: 100, // 忽略文件数量大于该数目的课程文件（比如 100 就表示不会去下载大于 100 个文件的那些文件）, -1 表示不忽略
    ignoreDay: -1,    // 忽略文件上传日期早于该数目天数的课程文件（比如 5 就表示 5 天前的文件都忽略掉不下载）, -1表示不忽略
    semesters: {
        // 2017-2018-x，x可以填3个数字，1是秋季学期，2是春季学期，3是夏季学期
