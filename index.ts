        ...
        for (let course of courses) {
            ...
            if (config.courseType === CourseType.TEACHER) {
                ...
                for (let student of students) {
                    content += `\n${student.student_id},${student.real_name},${student.gender},${student.class_name.trim()},${student.student_type},${student.department},${student.phone_number},${student.email},${student.nationality}`;
                }
